...
<%@ page import="com.stonesun.realTime.services.servlet.UpgradeServlet" %>
<%
...
//文件保存目录路径
String savePath = pageContext.getServletContext().getRealPath("/") + "attached/upgrade/";
boolean deleteFlg = UpgradeServlet.deleteVersionFile(savePath);
//对用户Id做限制
...
//文件保存目录URL
String saveUrl  = request.getContextPath() + "/attached/upgrade/";
