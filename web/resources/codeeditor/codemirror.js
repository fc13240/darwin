...
(function(mod) {
  ...
  function Display(place, doc) {
    ...
    if (ios) input.style.border = "1px solid #c0c0c0";
  ...
  function compensateForHScroll(display) {
	  //console.log(display);
	  //console.log(display.scroller.getBoundingClientRect().left);
	  //console.log(display.sizer.getBoundingClientRect().left);
  ...
  function updateLineGutter(cm, lineView, lineN, dims) {
    ...
    if (cm.options.lineNumbers || markers) {
      var wrap = ensureLineWrapped(lineView);
      //console.log(cm.options.fixedGutter);
      //console.log(dims);
