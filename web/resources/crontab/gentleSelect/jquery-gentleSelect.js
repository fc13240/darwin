...
(function($) {
    ...
    function hasError(c, o) {
        ...
        if (!defined(o.openEffect) || (o.openEffect != "fade" && o.openEffect != "slide"&& o.openEffect != "no")) {
    ...
    var methods = {
        ...
        setDisabled : function(){
           defaults.openEffect="no";
        },

        setAbled : function(){
            defaults.openEffect="fade";
        }
    };
    ...
    var event_handlers = {
        ...
        labelClick : function() {
            ...
            var dialog = root.data("dialog")
                ...
                .css("left", pos.left + 1);
            if (defaults.openEffect == "fade") {
                dialog.fadeIn(opts.openSpeed);
            }else if (defaults.openEffect == "no") {
