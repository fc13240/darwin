		...
		<div class="row">
			<div class="col-xs-6 col-md-6">
				...
				<div class="page-header-links">
					<a href="<%=request.getContextPath() %>/analytics?method=index">分析</a> / 添加分析
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-3">
				    <ul id="myTab" class="nav nav-tabs" role="tablist">
				      ...
				      <li role="presentation" class=""><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">数据</a></li>
				    </ul>
				    <div id="myTabContent" class="tab-content">
				      <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
				      		<div class="input-group input-group-sm" style="margin: 10px 0;">
							  <input id="anaKeywordInput" type="text" class="form-control" placeholder="搜索分析关键字" aria-describedby="basic-addon2">
				      ...
				      <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				      		<div class="input-group input-group-sm" style="margin: 10px 0;">
							  <input id="dsKeywordInput" type="text" class="form-control" placeholder="搜索数据关键字" aria-describedby="basic-addon2">
							  <span class="input-group-btn">
			...
			<div class="col-md-8">
				...
				%>
				<form action="<%=request.getContextPath() %>/analytics?method=save" method="post" class="form-horizontal" role="form" onclick="return func();">
					<input value="${ana.id}" name="id" id="id" type="hidden"/>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button class="btn btn-success" type="submit" href="<%=request.getContextPath() %>/analytics?method=index">保存分析</button>
...
<%-- 							<button class="btn btn-default" type="submit" href="<%=request.getContextPath() %>/analytics?method=index">运行历史</button> --%>
					...
					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">分析名称</label>
						<div class="col-sm-5">
