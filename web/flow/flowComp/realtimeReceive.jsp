...
<script src="<%=request.getContextPath() %>/flow/flowComp/realtimeReceive/js/lib/angular.js"></script>
<script src="<%=request.getContextPath() %>/flow/flowComp/realtimeReceive/js/import.js"></script>
...
<div ng-app="comp" ng-controller="compCtrl" ng-init="init()">
	...
	<div class="panel panel-default">
		<ol class="breadcrumb">
			...
			<li class="active">实时接收组件配置</li>
		</ol>
		<div class="form-group">
			<label for="name" class="col-sm-3 control-label"><span class="redStar">*&nbsp;</span>组件名称</label>
			<div class="col-sm-5">
				<input value="{{cleancompConfig.compname}}"  ng-model="cleancompConfig.compname" class="form-control input-inline" placeholder="组件名称" id="name" name="postForm[name]" data-rule="required;length[1~45];"/>
			</div>
			<div class="col-sm-1">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<store-set es-index='${sessionScope.session_esIndexList}' comp-id='${compId}' ></store-set>
				</div>
			</div>
		</div>
	</div>
