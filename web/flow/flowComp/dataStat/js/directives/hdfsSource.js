...
module.directive('hdfsSource', function() {
    return {
      ...
      scope:{
    	...
    	templateUrl: 'dataStat/partials/hdfs-source.html',
        replace: true,
        ...
        if (browerType1.indexOf("Firefox")>-1) {
          ...
          $scope.browserType="other"
    		...
    		console.log(statCompConfig.config)
            ...
            $scope.changeTemplates = function(){
                ...
                .success(function(data, status, headers, config){
                    var rr = angular.fromJson(data.dsInfo.ruleConf);
                     ...
                     $scope.inputinfo.dataRangeDetail.filenameMatch=rr.dataRangeDetail.dirnameTimeRule
                     ...
                     console.log($scope.inputinfo)
                     /*$scope.inputinfo=rr.dataName;

                     
                     $scope.inputinfo.colDetail = [];
                

                     $scope.inputinfo.colDetail = rr.colDetail;
                     $scope.inputinfo.colCount = $scope.inputinfo.colDetail.length;*/
