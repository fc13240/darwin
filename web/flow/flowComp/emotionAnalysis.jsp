...
<script src="<%=request.getContextPath() %>/flow/flowComp/emotionAnalysis/js/import.js"></script>
...
<div ng-app="comp" ng-controller="compCtrl" ng-init="init()">
	<form id="rightForm" name="postForm" action="<%=request.getContextPath() %>/flowComp?method=save" method="post" class="form-horizontal" role="form" data-validator-option="{theme:'yellow_right_effect',stopOnError:true}" >
	...
	<div class="panel panel-default">
		<ol class="breadcrumb">
			...
			<li class="active">正负面情绪分析组件配置</li>
		</ol>
