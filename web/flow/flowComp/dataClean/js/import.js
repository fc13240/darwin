...
document.write('<script src="'+rootPath+'directives/configFilter.js"></script>');
document.write('<script src="'+rootPath+'directives/configField.js"></script>');

document.write('<script src="'+rootPath+'directives/configSet.js"></script>');
document.write('<script src="'+rootPath+'directives/configJoin.js"></script>');
