...
document.write('<script src="'+rootPath+'services/utils.js"></script>');//其实可以考虑复用dataClean下的utils
...
document.write('<script src="'+rootPath+'directives/sourceSet.js"></script>');//其实可以考虑复用dataClean下的sourceSet
document.write('<script src="'+rootPath+'directives/hdfsSource.js"></script>');//其实可以考虑复用dataClean下的
