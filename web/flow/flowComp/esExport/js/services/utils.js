...
module.service('utils',function(esExportConfig,$http,$q){
	var self = this;
	...
	this.getcolname = function(){
		var colname = [];
		angular.forEach(esExportConfig.config.inputinfo,function(v,k){
		...
		angular.forEach(esExportConfig.config.config.vcol, function(v,i){
	...
	this.getAllCols = function() {
		var cols = [];
		angular.forEach(esExportConfig.config.inputinfo, function(v,i){
