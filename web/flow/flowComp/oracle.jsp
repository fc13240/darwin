...
<div class="panel panel-default">
	<ol class="breadcrumb">
		...
		<li class="active">oracle数据获取配置</li>
	</ol>
			...
			<div class="panel panel-darwin">
				...
				<div class="panel-body">
					<div class="box box-default">
						...
						<div class="box-body">
							<span id="conn-count">${rulesize}</span>个Oracle设置
						</div>
						<div>
...
<%-- 						<input value="${config.config.encode}" class="form-control input-inline" placeholder="数据库编码" id="encode" name="encode" data-rule="required;length[1~45];"/> --%>
					...
					<div class="form-group" style="diaplay:none"><label for="threads" class="control-label"><span class="redStar">*&nbsp;</span>并发线程数</label>
						<div>
		...
		<div class="modal-content content">
			<div class="modal-header header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
 				<h4 class="modal-title" id="myModalLabel">Oracle连接设置</h4>
 			</div>
 			<div class="modal-body">
				...
				<table class="table table-bordered table-hover" id="ruleTable" style="margin-bottom: 100px;">
					<tr>
						...
						<td width="100"><span class="redStar">*&nbsp;</span>数据库</td>
						...
						<tr class="tr-setting">
							...
							<td>
								<select class="form-control"  id="connId1" name="connId" data-rule="required;">
									<c:forEach items="${sessionScope.session_oracleList}" var="list">
					...
					<c:forEach var="stu" items="${rules}" varStatus="status">
						<tr class="tr-setting">
							...
							<td>
								<select class="form-control" name="connId" id="connId${status.index + 1}" data-rule="required;" >
...
<div id="oracleJson" style="display: none;">
...
// 	    						console.log(v ? '5表单验证通过' : '5表单验证不通过');
	...
	var oraclelist_select;
	$(function(){
		oraclelist_select = $("#oracleJson").html();
		$("#oracleJson").remove();
		//通用按钮的提交表单事件
